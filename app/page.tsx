...
export default function LoginPage() {
  ...
  // We need to return a custom element that ignores the layout
  return (
    // 1. Full screen container
    <div className="absolute top-0 left-0 right-0 bottom-0 w-full h-full bg-[#f5f5f7] z-[9999]">
      {/* 2. Background image container - must be positioned for fill to work */}
      ...
      <div className="relative w-full h-full flex items-center justify-center">
        <div className="w-full max-w-md px-6 flex flex-col items-center z-10">
          ...
          <div className="mt-8 text-center text-[12px] text-gray-500">
            <p>
              Demo credentials: <br />
              SoDap ID: <span className="font-medium">sodap</span>, Password: <span className="font-medium">sodap</span><br />
              User: <span className="font-medium">tamkin</span>, Password: <span className="font-medium">test1234</span>
            </p>
          </div>
        </div>
      </div>
